    ...
    <table class="table-auto w-full">
      ...
      <tbody v-else>
        <tr v-for="(category, index) of categories?.data">
          ...
          <td v-if="category.description"
            class="border-b p-2 max-w-[200px] whitespace-nowrap overflow-hidden text-ellipsis"
          >
              {{ category.description }}
          </td>
          <td v-else class="text-center border-b p-2 max-w-[200px]">
            N/A
          </td>
...
async function getCategories(url = null) {
...
function deleteCategory(category) {
  ...
  store.dispatch("categories/deleteCategory", category.id).then(async(res) => {
    // TODO Show notification
    await store.dispatch("categories/getCategories");
    store.dispatch("toast/enableErrorToast", "Category deleted!");
  });
}
