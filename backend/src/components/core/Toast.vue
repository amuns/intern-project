<template>
  ...
  <div v-if="toast.type === 'error'"
    v-show="toast.show"
    class="fixed w-[400px] left-1/2 -ml-[200px] top-16 z-30 py-2 px-4 pb-4 bg-red-500 text-white"
  >
    <div class="font-semibold">{{ toast.message }}</div>
    <button
      @click="close"
  ...
  <div v-if="toast.type === 'warning'"
    v-show="toast.show"
    class="fixed w-[400px] left-1/2 -ml-[200px] top-16 z-30 py-2 px-4 pb-4 bg-yellow-500 text-white"
  >
    <div class="font-semibold">{{ toast.message }}</div>
    <button
      @click="close"
